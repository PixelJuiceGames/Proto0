...
// TODO: These should be autogenerated with some codegen solution
// from the shader (source of bytecode reflections) 
// DeferredShadingShader Descriptor Sets
struct SRT_DeferredShadingShaderData
{
	struct Persistent
	{
	...
	struct PerFrame
	{
		...
		const ::Descriptor gGBuffer0 =
		{
#if defined IF_VALIDATE_DESCRIPTOR
			"gGBuffer0", ROOT_PARAM_PerFrame,
#endif
			::DESCRIPTOR_TYPE_TEXTURE, 1, 1
		};
		const ::Descriptor gGBuffer1 =
		{
#if defined IF_VALIDATE_DESCRIPTOR
			"gGBuffer1", ROOT_PARAM_PerFrame,
#endif
			::DESCRIPTOR_TYPE_TEXTURE, 1, 2
		};
		const ::Descriptor gGBuffer2 =
		{
#if defined IF_VALIDATE_DESCRIPTOR
			"gGBuffer2", ROOT_PARAM_PerFrame,
#endif
			::DESCRIPTOR_TYPE_TEXTURE, 1, 3
		};
		const ::Descriptor gGBuffer3 =
		{
#if defined IF_VALIDATE_DESCRIPTOR
			"gGBuffer3", ROOT_PARAM_PerFrame,
#endif
			::DESCRIPTOR_TYPE_TEXTURE, 1, 4
		};
		const ::Descriptor gDepthBuffer =
		{
#if defined IF_VALIDATE_DESCRIPTOR
			"gDepthBuffer", ROOT_PARAM_PerFrame,
#endif
			::DESCRIPTOR_TYPE_TEXTURE, 1, 5
		};
	}*pPerFrame;
